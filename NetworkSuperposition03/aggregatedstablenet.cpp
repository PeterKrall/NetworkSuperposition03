...
namespace model
{
    ...
    {
        return ((double)(Configuration::configuration->strain_1_exposition_in_aggregated_stable_net))/10000.0;
    }
    double AggregatedStableNet::get_strain2_transmission_probability()
    {
        return ((double)(Configuration::configuration->strain_2_exposition_in_aggregated_stable_net))/10000.0;
    }

    double AggregatedStableNet::get_strain1_exposure()
    {
        return get_strain1_transmission_probability();
    }
    double AggregatedStableNet::get_strain2_exposure()
    {
        return get_strain2_transmission_probability();
    }
} // namespace model
